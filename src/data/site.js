...
export const capabilities = [
  {
    ...
    description: 'Component systems, state patterns, and code structure made for long-term product velocity.',
    tag: 'build',
  },
  {
    index: '02',
  ...
  },
  {
    ...
    description: 'Fast, responsive, keyboard-friendly experiences that work beyond the ideal device.',
    tag: 'optimize',
  },
]
